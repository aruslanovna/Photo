...
<div class=grid>
<label for=pic-1 class=grid-item><img src="images/26.jpg"  width="300px"/></label>
<label for=pic-2 class=grid-item><img src="images/55.jpg"  width="300px"/></label>
<label for=pic-3 class=grid-item><img src="images/58.JPG"  width="300px"/></label>
<label for=pic-2 class=grid-item><img src="images/77.jpg"  width="300px"/></label><label for=pic-5 class=grid-item><img src="images/72.jpg"  width="300px"/></label>
<label for=pic-4 class=grid-item><img src="images/53.JPG" "  width="300px"/></label>
